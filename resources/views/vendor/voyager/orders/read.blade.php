    ...
    <div class="page-content read container-fluid">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="panel panel-bordered" style="padding-bottom:5px; color: black!important;">
                    <!-- form start -->
                    @foreach($dataType->readRows as $row)
                        ...
                        <div class="panel-body" style="padding-top:0;">
                            ...
                            @else
                                @include('voyager::multilingual.input-hidden-bread-read')
                                <p>
                                    @if(in_array($row->field,['billing_total','billing_subtotal','billing_tax','billing_discount']))
                                        <span style="color: orange;font-size:1.3rem;font-weight: bolder">$</span>@endif{{ $dataTypeContent->{$row->field} }}
                                </p>
                            @endif
                        </div><!-- panel-body -->
                        @if(!$loop->last)
            ...
            <div class="col-md-6">
                <div class="panel panel-bordered" style="padding-bottom:5px; background-color: orange">
                    <div class="panel-heading" style="border-bottom:0;">
                        <h3 class="panel-title">Products for this Order</h3>
                    </div>
                    <div class="panel-body " style="padding-top:0;">
                        <ul class="list-group-item-info" style="border-radius: 10px; padding: 20px">
                            @foreach ($products as $product)
                                <li style="margin-bottom: 10px;list-style: none;color: black;border-bottom:1px solid #1b4b72">
