    ...
    public function run()
    {
        ...
        for ($i = 1; $i <= 30; $i++) {
            Product::create([
                ...
                'image' => 'images/products/laptop-' . $i . '.jpg',
                'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
            ])->categories()->attach(2);
        }
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'image' => 'images/products/desktop-' . $i . '.jpg',
                'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
            ])->categories()->attach(3);
        }
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'image' => 'images/products/phone-' . $i . '.jpg',
                'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
            ])->categories()->attach(4);
        }
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'image' => 'images/products/tablet-' . $i . '.jpg',
                'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
            ])->categories()->attach(5);
        }
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'price' => rand(79999, 149999),
                'image' => 'images/products/tv-' . $i . '.jpg',
                'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
            ])->categories()->attach(6);
        }
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'details' => 'Full Frame DSLR, with 18-55mm kit lens.',
                'price' => rand(79999, 249999),
                'image' => 'images/products/camera-' . $i . '.jpg',
                'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
            ])->categories()->attach(7);
        }
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'price' => rand(79999, 149999),
                'image' => 'images/products/appliance-' . $i . '.jpg',
                'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
            ])->categories()->attach(8);
        }
